pipeline {
  ...
  parameters {
    ...
    choice(name: 'p2_repo_dir', choices: ["releases/2024-03/202403131000","releases/2023-12/202312061001", "releases/2023-09/202309131000", "releases/2023-06/202306141000"] , description: 'Path to P2 repository that is used for the info center (base path: /home/data/httpd/download.eclipse.org)<br/> Dir can be found here: <a href="https://download.eclipse.org/releases/">https://download.eclipse.org/releases/</a> &lt;release&gt;')
