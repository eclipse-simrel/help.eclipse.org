pipeline {
  ...
  parameters {
    ...
    choice(name: 'p2_repo_dir', choices: ["releases/2025-03/202503121000", "releases/2024-12/202412041000/", "releases/2024-09/202409111000", "releases/2024-06/202406121000"] , description: 'Path to P2 repository that is used for the info center (base path: /home/data/httpd/download.eclipse.org)<br/> Dir can be found here: <a href="https://download.eclipse.org/releases/">https://download.eclipse.org/releases/</a> &lt;release&gt;')
